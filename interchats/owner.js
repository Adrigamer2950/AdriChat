  ...
  if(comprobacion_owners) {
   ...
   if(message.channel.id === obtener){
     ...
     channel.createInvite({ unique: true }).then(invite => {
       ...
       .setColor("RANDOM")
       .setDescription(`:crown: **Owner** :crown: | [Invita al bot](https://discord.com/api/oauth2/authorize?client_id=755490775743201330&permissions=388161&scope=bot)`)
   ...
   if(message.channel.id === obtenerp){
     ...
     channel.createInvite({ unique: true }).then(invite => {
       ...
       .setColor("#188cb8")
       .setDescription(`:crown: **Owner** :crown: | [Invita al bot](https://discord.com/api/oauth2/authorize?client_id=755490775743201330&permissions=388161&scope=bot) | Canal privado`)
       .addField(`<a:peepo_clap:722055764826652824> Mensaje:`, message.content)
       .setThumbnail(message.guild.iconURL())
       .setFooter(`${message.guild.name}, ${message.guild.memberCount} miembros`, message.guild.iconURL({ dynamic: true }));
